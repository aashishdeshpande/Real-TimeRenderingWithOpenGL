package com.example.sknaa.OGLES2DRotation;
...
private void initialize(GL10 gl)
{
	...
	GLES31.glGenVertexArrays(1,vaoTriangle,0);
	GLES31.glBindVertexArray(vaoTriangle[0]);
	...
	GLES31.glGenVertexArrays(1,vaoSquare,0);
	GLES31.glBindVertexArray(vaoSquare[0]);
	GLES31.glGenBuffers(1,vbo_Position,0);
	GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER,vbo_Position[0]);
	...
	verticesBuffer.position(0);
	GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER, squareVertices.length * 4, verticesBuffer, GLES31.GL_STATIC_DRAW);
	GLES31.glVertexAttribPointer(GLESMacros.VDG_ATTRIBUTE_VERTEX, 3, GLES31.GL_FLOAT, false, 0, 0);
	GLES31.glEnableVertexAttribArray(GLESMacros.VDG_ATTRIBUTE_VERTEX);
	GLES31.glVertexAttrib3f(GLESMacros.VDG_ATTRIBUTE_COLOR, 0.392157f, 0.584314f, 0.929412f);
	GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER, 0);
	GLES31.glBindVertexArray(0);
...
public void display()
{
	...
	Matrix.rotateM(rotationMatrix, 0, angle_tri, 0.0f, 1.0f, 0.0f);
	...
	Matrix.setIdentityM(rotationMatrix, 0);
	Matrix.translateM(modelViewMatrix, 0, 1.5f, 0.0f, -5.0f);
	Matrix.rotateM(rotationMatrix, 0, angle_square, 1.0f, 0.0f, 0.0f);
	Matrix.multiplyMM(modelViewMatrix, 0 ,modelViewMatrix, 0, rotationMatrix, 0);
	Matrix.multiplyMM(modelViewProjectionMatrix, 0, perspectiveProjectionMatrix, 0, modelViewMatrix, 0);
	GLES31.glUniformMatrix4fv(mvpUnifrom, 1, false, modelViewProjectionMatrix, 0);
	GLES31.glBindVertexArray(vaoSquare[0]);
...
void uninitialize()
{
	if(vaoTriangle[0] != 0)
	{
		GLES31.glDeleteVertexArrays(1, vaoTriangle, 0);
		vaoTriangle[0] = 0;
	}
