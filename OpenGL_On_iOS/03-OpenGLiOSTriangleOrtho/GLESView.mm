...
-(void)layoutSubviews
{
    ...
    GLfloat orthowidth = (GLfloat)width;
    GLfloat orthoheight = (GLfloat)height;
    
    if (orthowidth <= orthoheight)
        orthographicProjectionMatrix = vmath::ortho(-100.0f, 100.0f, (-100.0f * (orthoheight / orthowidth)), (100.0f * (orthoheight / orthowidth)), -100.0f, 100.0f);
    else
        orthographicProjectionMatrix = vmath::ortho((-100.0f * (orthowidth /orthoheight)),  (100.0f * (orthowidth / orthoheight)), -100.0f, 100.0f, -100.0f, 100.0f);
