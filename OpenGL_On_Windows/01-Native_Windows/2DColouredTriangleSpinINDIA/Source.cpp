...
void display(void)
{
	...
	glColor3f(1.0f, 1.0f, 1.0f);
	glVertex3f(0.21f, -0.6f, 0.0f);
	glColor3f(0.0f, 1.0f, 0.0f);
	glVertex3f(0.24f, -0.6f, 0.0f);
	glColor3f(0.8f, 0.8f, 0.2f);
	glVertex3f(0.24f, 0.57f, 0.0f);
	//glLoadIdentity();
	glEnd();
	...
	glVertex3f(0.26f, 0.6f, 0.0f);
	glColor3f(1.0f, 1.0f, 1.0f);
	glVertex3f(0.31f, -0.6f, 0.0f);
	glColor3f(0.0f, 1.0f, 0.0f);
	glVertex3f(0.33f, -0.6f, 0.0f);
