...
#include<gl/GL.h>
#include "vmath.h"
#include "OpenGLPPTweakSmileyWhiteSQDefault.h"
...
void initialize(void)
{
	...
	//const GLfloat smileyTexcoords[8];
	//SMILEY
...
void LoadGLTexturesWhiteSquare(void)
{
...
void display(void)
{
	...
	switch (digitKeyIsPressed)
	{
		case 1: 
			...
			glBindBuffer(gVbo_smiley_texture, 0);
