...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindow(szClassName,
		TEXT("OpenGL Programmable Pipeline Window : Square And Triangle"),
		WS_OVERLAPPEDWINDOW,
		100,
		100,
		WIN_WIDTH,
...
void initialize(void)
{
	...
	glGenVertexArrays(1, &gVao_Trinagle);
	glBindVertexArray(gVao_Trinagle);
	...
	glEnableVertexArrayAttrib(gVao_Trinagle, VDG_ATTRIBUTE_VERTEX);
	...
	glEnableVertexArrayAttrib(gVao_Square, VDG_ATTRIBUTE_VERTEX);
...
void uninitialize(void)
{
	...
	if (gVao_Trinagle)
	{
		glDeleteVertexArrays(1, &gVao_Trinagle);
		gVao_Trinagle = 0;
	}
