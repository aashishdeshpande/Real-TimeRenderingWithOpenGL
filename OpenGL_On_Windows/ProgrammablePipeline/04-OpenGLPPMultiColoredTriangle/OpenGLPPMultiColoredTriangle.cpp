...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindow(szClassName,
		TEXT("OpenGL Programmable Pipeline Window : MultiColored Triangle"),
		WS_OVERLAPPEDWINDOW,
		100,
		100,
		WIN_WIDTH,
...
void initialize(void)
{
	...
	glEnableVertexArrayAttrib(gVao, VDG_ATTRIBUTE_VERTEX);
	...
	glEnableVertexArrayAttrib(gVao, VDG_ATTRIBUTE_COLOR);
